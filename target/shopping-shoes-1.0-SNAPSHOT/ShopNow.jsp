            ...
            <div class="body">
                ...
                <div class="slideBar">
                    <div class="slideBar__search">
                        <h2>Search here...</h2>
                        <form action="search-product" class="slideBar__search-item">
                            <input type="text" name="product_name" value="${search}" placeholder="Product name..." required/>
                    ...
                    <div class="slideBar__price">
                        ...
                        <div class="price-input">
                            <input oninput="getProByPrice()" type="number" id="input-min" name="min" value="${sessionScope.min}" />
                            <i class="fa-solid fa-window-minimize"></i>
                            <input oninput="getProByPrice()" type="number" id="input-max" name="max" value="${sessionScope.max}" />
                        </div>
                    </div>
                        ...
                        <c:if test="${not empty lastProduct}">
                            <div class="last-product">           
                                <div class="last-product__img">
                                    ...
                                    <img src="./image/${lastProduct.imageLink}" alt="" />
                                </div>
